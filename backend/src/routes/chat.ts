...
router.get('/chat/history', authenticateToken, async (req: AuthenticatedRequest, res) => {
  try {
...
router.get('/chat/threads', authenticateToken, async (req: AuthenticatedRequest, res) => {
  try {
    const userId = req.user!.userId;
...
router.post('/chat/threads', authenticateToken, async (req: AuthenticatedRequest, res) => {
  try {
    const userId = req.user!.userId;
...
router.put('/chat/threads/:id', authenticateToken, async (req: AuthenticatedRequest, res) => {
  try {
    const userId = req.user!.userId;
    const { id } = req.params;
...
router.delete('/chat/threads/:id', authenticateToken, async (req: AuthenticatedRequest, res) => {
  try {
    const userId = req.user!.userId;
    const { id } = req.params;
...
router.get('/chat/threads/:id/messages', authenticateToken, async (req: AuthenticatedRequest, res) => {
  try {
    const userId = req.user!.userId;
    const { id } = req.params;
...
router.post('/chat', authenticateToken, async (req: AuthenticatedRequest, res) => {
  try {
    const userId = req.user!.userId;
    const { message, threadId, stream = false } = req.body as {
      message: string;
      threadId?: string;
      stream?: boolean;
    };
